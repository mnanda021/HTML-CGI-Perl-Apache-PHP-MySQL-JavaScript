  ...
  <div id="container" class="clear">
    ...
    <div id="homepage">
      ...
      <section id="intro" class="last clear">
        <article>
          <figure><h2>Welcome to Our Winestore</h2>
              <p>Most people have had a pleasant experience with wine – over a nice dinner, at an event or simply with friends at home. Not many can recall the pleasure of shopping for wine.</p><p>Our goal is to provide a fun, educational and non-intimidating shopping experience for wine lovers of all levels of expertise</p>
              <footer class="more"><a href="http://136.176.32.60/FashionClub/query.php"><h3>Explore our Wine Store &raquo;</h3></a></footer>
             <br><br>
            <figcaption>
               </figcaption>
          </figure>
        ...
        <article class="one_third">
          ...
          <figure><img src="images/3wines.jpg" width="290" height="250" alt="">
            <figcaption>
              Fashion Camp,Bradley University-2017 
        ...
        <article class="one_third">
          <figure><img src="images/wine-tasting.jpg" width="290" height="250" alt="">
            <figcaption>
              Summer Fashion-Paris, 2017 
        ...
        <article class="one_third lastbox">
          <figure><img src="images/wine.jpg" width="290" height="250" alt="">
            <figcaption>
              Fashion Camp- 2017
        ...
        <article class="one_third">
          ...
          <figure><img src="images/Glasses-of-wine-002.jpg" width="290" height="250" alt="">
            <figcaption>
              Fashion Camp,Bradley University-2017 
        ...
        <article class="one_third">
          <figure><img src="images/malvasia-winery.jpg" width="290" height="250" alt="">
            <figcaption>
              Summer Fashion-Paris, 2017 
        ...
        <article class="one_third lastbox">
          <figure><img src="images/wine4.jpg" width="290" height="250" alt="">
            <figcaption>
              Fashion Camp- 2017
